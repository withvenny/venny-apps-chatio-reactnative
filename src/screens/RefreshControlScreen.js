...
const enappdIcon = require('src/assets/enappd.png');
const widthConst = Dimensions.get('screen').width;

export default function App() {
  const IMAGES = {
    image1: require('src/assets/1.png'), image2: require('src/assets/2.png'), image3: require('src/assets/3.png'), image4: require('src/assets/4.png'), image5: require('src/assets/5.png'), image6: require('src/assets/6.png'), image7: require('src/assets/7.png'), image8: require('src/assets/8.png'), image9: require('src/assets/9.png'), image10: require('src/assets/10.png'),
  }
  const initialData = [
    {
